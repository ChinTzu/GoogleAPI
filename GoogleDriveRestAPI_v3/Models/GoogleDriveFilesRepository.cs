...
namespace GoogleDriveRestAPI_v3.Models
{
    public class GoogleDriveFilesRepository
    {
        ...
        public static List<GoogleDriveFiles> GetDriveFiles(IHostingEnvironment env)
        {
            _env = env;
        ...
        public static void FileUpload(IFormFile file)
        {
            ...
            {
                var path = Path.Combine(_env.ContentRootPath, "GoogleDriveFiles/");
        ...
        public static string DownloadGoogleFile(string fileId)
        {
            ...
            string FolderPath = Path.Combine(_env.ContentRootPath, "GoogleDriveFiles/");
